...
const GRBLHAL_ALARM_CODES: Record<number, string> = {
    ...
    4: 'Probe fail. Probe did not contact the workpiece within the programmed travel for G38.2 and G38.4.',
    5: 'Probe fail. Probe did not clear the workpiece before starting the probe cycle, or probe was already triggered.',
    6: 'Homing fail. The active homing cycle was reset.',
    7: 'Homing fail. Safety door was opened during homing cycle.',
    8: 'Homing fail. Cycle failed to clear limit switch when pulling off. Try increasing pull-off setting.',
    9: 'Homing fail. Could not find limit switch within search distance. Try increasing max travel.',
    10: 'Homing fail. Homing not enabled in settings.',
    11: 'Homing fail. Homing cycle not enabled in settings.',
    12: 'Homing fail. Homing cycle not enabled in settings.',
    13: 'Homing fail. Homing cycle not enabled in settings.',
    14: 'Homing fail. Homing cycle not enabled in settings.',
    15: 'Homing fail. Homing cycle not enabled in settings.',
    16: 'Homing fail. Homing cycle not enabled in settings.',
    17: 'Homing fail. Homing cycle not enabled in settings.',
